...
/**
 * WebTestClient replacement for [WebTestClientRestDocumentation] that adds a [ResourceSnippet]
 * built from the descriptors in the supplied snippets.
 */
object WebTestClientRestDocumentationWrapper : RestDocumentationWrapper() {
    ...
    fun <T : Any> document(
        ...
        snippetFilter: Function<List<Snippet>, List<Snippet>> = Function.identity(),
        vararg snippets: Snippet
    ): Consumer<EntityExchangeResult<T>> = document(
    ...
    @JvmStatic
    fun resourceDetails(): ResourceSnippetParametersBuilder = ResourceSnippetParametersBuilder()
}
